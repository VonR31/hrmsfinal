...
// SQL query to fetch departments and their employees
$sqlDept = "SELECT d.departmentName, CONCAT(e.firstName, ' ', e.lastName) AS employee_name
        FROM department d
...
if ($resultDept->num_rows > 0) {
  while ($row = $resultDept->fetch_assoc()) {
    $departments[$row['departmentName']][] = $row['employee_name'];
  }
}

$sqlPos = "SELECT p.positionName, CONCAT(e.firstName, ' ', e.lastName) AS employee_name
      FROM position p
      JOIN employee e ON p.positionId = e.positionId
      ORDER BY p.positionName, e.firstName, e.lastName";
...
if ($resultPos->num_rows > 0) {
  while ($row = $resultPos->fetch_assoc()) {
    $positions[$row['positionName']][] = $row['employee_name'];
  }
  ...
  <div class="main-wrapper">
        ...
        <div class="sidebar-contents">
          <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
              ...
              <li>
                <a href="attendance.php"><img src="assets/img/calendar.svg"
                    alt="sidebar_img" /><span>Attendance</span></a>
              </li>
              <li>
                <a href="payroll.php"><img src="assets/img/payroll.svg" alt="sidebar_img" /><span>Payroll</span></a>
              </li>
              <li>
    ...
    <div class="page-wrapper">
            ...
            <div class="breadcrumb-path mb-4">
              <ul class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="dashboard.php"><img src="assets/img/dash.png" class="mr-2" alt="breadcrumb" />Home</a>
                </li>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <?php if (!empty($departments)) { ?>
                  <?php foreach ($departments as $departmentName => $employees) { ?>
                    <div class="col-xl-3 col-sm-12 col-12 d-flex m-4">
                      <div class="card card-list flex-fill">
                        <div class="card-dept">
                          <h4 class="card-title-dash "><?php echo $departmentName; ?></h4>
                        </div>
                        <div class="card-body p-2">
                          <ul>
                            <?php foreach ($employees as $employeeName) { ?>
                              <li><?php echo $employeeName; ?></li>
                            <?php } ?>
                          </ul>
                        </div>
                      </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <?php if (!empty($positions)) { ?>
                  <?php foreach ($positions as $positionName => $employees) { ?>
                    <div class="col-xl-3 col-sm-12 col-12 d-flex m-4">
                      <div class="card card-list flex-fill">
                        <div class="card-dept">
                          <h4 class="card-title-dash "><?php echo $positionName; ?></h4>
                        </div>
                        <div class="card-body p-2">
                          <ul>
                            <?php foreach ($employees as $employeeName) { ?>
      ...
      <div class="col-12">
        <div class="row">
          <div class="col-auto">
            <a href="#" class="btn btn-primary mr-1" data-toggle="modal" data-target="#addDepartmentModal">
              Add Department
            </a>
          </div>

          <div class="col-auto">
            <a href="#" class="btn btn-primary mr-1" data-toggle="modal" data-target="#addPositionModal">
              Add Position
            </a>
          </div>
        </div>
