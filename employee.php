...
$query = "SELECT e.firstName, e.lastName, e.email, p.positionName, d.departmentName, p.salaryGrade, e.status 
          FROM employee e
...
// Fetch employees with 'employee' role
$queryEmployees = "SELECT userId, firstName, lastName, email FROM user WHERE roles = 'employee'";
...
<body>
  <div class="main-wrapper">
        ...
        <div class="sidebar-contents">
          <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
              ...
              <li>
                <a href="payroll.php"><img src="assets/img/payroll.svg" alt="sidebar_img" />
                  <span>Payroll</span></a>
              </li>
              <li>
    ...
    <div class="page-wrapper">
      <div class="content container-fluid">
        ...
        <div class="col-xl-12 col-sm-8 col-12 mt-4">
          <div class="card">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<td><label>{$row['positionName']}</label></td>";
                      echo "<td><label>{$row['departmentName']}</label></td>";
                      echo "<td><label>{$row['salaryGrade']}</label></td>"; // Display salaryGrade
          ...
          <div class="row">
            ...
            <div class="col-auto mt-1">
              <button type="button" class="btn-remove btn-danger" data-toggle="modal" data-target="#deleteAccountModal">
                <i data-feather="minus"></i> Delete Account
              </button>
            </div>

            <!-- Delete Account Modal -->
            <div id="deleteAccountModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      <td><button class="btn btn-danger delete-button" data-user-id="${employee.userId}">Delete</button></td>
    `;
