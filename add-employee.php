...
$positions_query = "SELECT positionId, positionName FROM position";
$positions_result = mysqli_query($conn, $positions_query);

// Fetch departments from the database
$departments_query = "SELECT departmentId, departmentName FROM department";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $empPositionId = $_POST['position_id'];
  $empDepartmentId = $_POST['department_id'];
  ...
  try {
    ...
    $insert_employee_query = "INSERT INTO employee (firstName, lastName, email, positionId, departmentId, dateOfHire) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt_employee = $conn->prepare($insert_employee_query);
    if (!$stmt_employee) {
      throw new Exception("Employee statement preparation failed: " . $conn->error);
    }
    $stmt_employee->bind_param("sssiis", $empFirstName, $empLastName, $empEmail, $empPositionId, $empDepartmentId, $empDateOfHire);
        ...
        <div class="sidebar-contents">
          <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
              ...
              <li>
                <a href="payroll.php"><img src="assets/img/payroll.svg"
                    alt="sidebar_img" /><span>Payroll</span></a>
              </li>
              <li>
            ...
            <ul class="logout">
              <li>
                <a href="index.php"><img src="assets/img/logout.svg" alt="sidebar_img" /><span>Log out</span></a>
              </li>
            </ul>
          </div>
        </div>
